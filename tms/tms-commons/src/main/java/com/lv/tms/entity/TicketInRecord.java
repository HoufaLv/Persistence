...
public class TicketInRecord implements Serializable {
     ...
     * 开始票号
     */
    private Integer beginTicketNum;

    /**
     * 结束票号
     */
    private Integer endTicketNum;
    ...
    public Integer getBeginTicketNum() {
        return beginTicketNum;
    }

    public void setBeginTicketNum(Integer beginTicketNum) {
        this.beginTicketNum = beginTicketNum;
    }

    public Integer getEndTicketNum() {
        return endTicketNum;
    }

    public void setEndTicketNum(Integer endTicketNum) {
